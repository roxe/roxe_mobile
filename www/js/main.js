...
var renderHome = function() {
        ...
        $.getJSON("http://www.roxlr.com:9293/imgs", function(data) {
                var template = "<ul class='row' >{{#.}}<li ><span class='timeSince glyphicon glyphicon-time' style='float:right;'>{{#noop}}{{created_at}}{{/noop}}</span><div class='view'><img class='img-responsive' src='http://www.roxlr.com:9293/uploads/{{account_id}}/{{photo_id}}.l.jpg'>" +
